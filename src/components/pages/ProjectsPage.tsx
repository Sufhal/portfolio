	...
	return (
		<>
			<Section sector={0} stage={{
				cameraPosition: new Vector3(-24.722341944706358, -95.03559922380308, 86.82532499721374),
				orbitTarget: new Vector3(5.351257227228121, 17.546029287454207, -15.03888965750754),
				isLocked: false,
				engineSpeed: .1,
				splitFactor: 0,
				shakeStrength: 0,
					...
					<div>
						<ScopeAnimation>
							...
							<ParagraphsContainer>
								...
								<NativeList>
									<NativeListEntry>Générateur de particules calculé sur le GPU avec GPGPU</NativeListEntry>
									<NativeListEntry>Toutes les textures réalisés avec des shaders GLSL custom</NativeListEntry>
									<NativeListEntry>Instanciation de tous les modèles</NativeListEntry>
									<NativeListEntry>Indexation spatiale des objets pour les collisions</NativeListEntry>
									<NativeListEntry>Utilisation des WebWorkers pour le calcul des matrices</NativeListEntry>
									<NativeListEntry>Utilisation d'IndexedDB pour la mise en cache des modèles</NativeListEntry>
								</NativeList>
							</ParagraphsContainer>
						</ScopeAnimation>
					</div>
					...
					<div>
						<ScopeAnimation>
							...
							<ParagraphsContainer>
								...
								<LargeLink href='https://github.com/Sufhal/m2rs'>Voir le Git</LargeLink>
							</ParagraphsContainer>
							<ParagraphsContainer>
								<DiscreteHeading>Technologies & fonctionnalités</DiscreteHeading>
								<NativeList>
									<NativeListEntry>Écriture d'un moteur graphique from scratch</NativeListEntry>
									<NativeListEntry>Parsing et rendu des modèles GLTF</NativeListEntry>
									<NativeListEntry>Instanciation de tous les modèles</NativeListEntry>
									<NativeListEntry>Parsing et rendu des squelettes et des animations</NativeListEntry>
									<NativeListEntry>Génération des ombres</NativeListEntry>
									<NativeListEntry>Raycast pour la gestion des collisions</NativeListEntry>
									<NativeListEntry>Environnement dynamique: nuages, brouillard, ciel et lumières</NativeListEntry>
								</NativeList>
							</ParagraphsContainer>
						</ScopeAnimation>
					</div>
