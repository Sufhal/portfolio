				...
				<Cards>
					<Card noAnimation>
						<ScopeAnimation>
							...
							<List>
								...
								<ListEntry>
									<LargeLink href={'https://fr.wikipedia.org/wiki/Feuilles_de_style_en_cascade'}>
										CSS
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://fr.wikipedia.org/wiki/Sass_(langage)'}>
										SCSS
									</LargeLink>
									<Skill lv={2} />
								</ListEntry>
								...
								<ListEntry>
									<LargeLink href={'https://fr.wikipedia.org/wiki/Rust_(langage)'}>
										Rust
									</LargeLink>
									<Skill lv={2} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://fr.wikipedia.org/wiki/OpenGL_Shading_Language'}>
										WGSL
									</LargeLink>
									<Skill lv={2} />
								</ListEntry>
					...
					<Card noAnimation>
						<ScopeAnimation>
							...
							<List>
								<ListEntry>
									<LargeLink href={'https://react.dev/'}>
										React
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://nextjs.org/'}>
										Next
									</LargeLink>
									<Skill lv={2} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://www.solidjs.com/'}>
										Solid
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								...
								<ListEntry>
									<LargeLink href={'https://lit.dev/'}>
										Lit
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://v2.vuejs.org/'}>
										Vue
									</LargeLink>
									<Skill lv={2} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://threejs.org/'}>
										THREE
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://animejs.com/'}>
										Anime
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								...
								<ListEntry>
									<LargeLink href={'https://v2.tauri.app/fr//'}>
										Tauri
									</LargeLink>
									<Skill lv={1} />
								</ListEntry>
					...
					<Card noAnimation>
						<ScopeAnimation>
							...
							<List>
								<ListEntry>
									<LargeLink href={'https://nodejs.org/en'}>
										Node
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								...
								<ListEntry>
									<LargeLink href={'https://socket.io/'}>
										Socket.io
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://adonisjs.com/'}>
										Adonis
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
					...
					<Card noAnimation>
						<ScopeAnimation>
							...
							<List>
								...
								<ListEntry>
									<LargeLink href={'https://www.adobe.com/fr/products/photoshop.html'}>
										Photosop
									</LargeLink>
									<Skill lv={2} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://www.adobe.com/fr/products/illustrator.html'}>
										Illustrator
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://www.adobe.com/fr/products/indesign.html'}>
										Indesign
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
					...
					<Card noAnimation>
						<ScopeAnimation>
							...
							<List>
								<ListEntry>
									<LargeLink href={'https://www.docker.com/'}>
										Docker
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								...
								<ListEntry>
									<LargeLink href={'https://pnpm.io/fr/'}>
										pnpm
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								<ListEntry>
									<LargeLink href={'https://fr.wikipedia.org/wiki/General-purpose_processing_on_graphics_processing_units'}>
										gpgpu
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
								...
								<ListEntry>
									<LargeLink href={'https://jestjs.io/fr/'}>
										Jest
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
					...
					<Card noAnimation>
						<ScopeAnimation>
							...
							<List>
								<ListEntry>
									<LargeLink href={'https://fr.wikipedia.org/wiki/Microsoft_Windows'}>
										Windows
									</LargeLink>
									<Skill lv={3} />
								</ListEntry>
